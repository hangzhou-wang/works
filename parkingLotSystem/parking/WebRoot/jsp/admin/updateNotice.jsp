...
<div id="plost">
	...
	<form id="noticeForm" action="<%=basePath %>updateNotice" method="post" oninput="checkNull()">
		<input type="hidden" name="notice.id" value="<s:property value='notice.id'/>"/>
		<table id="lostTable">
			<tr>
				<td colspan="2" style="text-align:center;"><font size="5">修改公告</font></td>
			</tr>
			<tr>
				<td><img src="<%=basePath%>images/icons/title.png" align="absmiddle">标题</td>
				<td><input id="title" type="text" name="notice.title" value="<s:property value='notice.title'/>"/></td>
				<td><span id="title_tip"></span></td>
			</tr>
			<tr>
				<td style="margin-top:-20px;"><img src="<%=basePath%>images/icons/content.png" align="absmiddle">内容</td>
				<td><textarea id="content" rows="4" cols="30"  name="notice.content">
			...
			<tr>
				<td colspan="2" style="text-align:center;">
					<input type="button" id="publishNotice" onclick="clickNotice()" value="修改"/>
				</td>
			</tr>
		</table>
	</form>
