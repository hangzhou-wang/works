...
public class UsersDaoImpl extends HibernateDaoSupport implements UsersDao {
	...
	/*修改用户基本信息*/
	@Override
	public int modifyUserInfo(Users user) {
		String hql="update Users u set u.realname=? , u.phone=? ,u.address=?,u.email=? where u.id=? ";
		Object[] args={user.getRealname(),user.getPhone(),user.getAddress(),user.getEmail(),user.getId()};
		return getHibernateTemplate().bulkUpdate(hql, args);
	}
